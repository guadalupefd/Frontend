...
export const service = {
    registerUser: async (username, mail, token) => await api.post(REGISTER_USER, {username, mail, password, token}),
    loginUser: async (mail, password) => await api.post(LOGIN_USER, {mail, password}),
    registerConsultant: async (username, mail, token) => await api.post(REGISTER_CONSULTANT, {username, mail, password, token}),
